...
const routes = [
  ...
  { path: '/users', name: 'Users', element: UserList, exact: true, roles: ['Admin', 'Super Admin'] },
  { path: '/users/create', name: 'Create User', element: CreateUser, roles: ['Admin', 'Super Admin'] },
  { path: '/users/edit/:id', name: 'Edit User', element: CreateUser, roles: ['Admin', 'Super Admin'] },
  { path: '/users/approvals', name: 'Approval List', element: ApprovalList, roles: ['Admin', 'Super Admin'] },
  ...
  },
  {
    ...
    exact: true,
    roles: ['Admin', 'Super Admin', 'HR', 'Case Manager', 'SheetalAdmin'],
  },
  {
